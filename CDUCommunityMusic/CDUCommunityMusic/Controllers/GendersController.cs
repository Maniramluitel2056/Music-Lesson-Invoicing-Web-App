...
namespace CDUCommunityMusic.Controllers
{
    public class GendersController : Controller
    {
        ...
        public GendersController(CDUCommunityMusicContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Gender")] Genders genders)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Gender")] Genders genders)
        {
            if (id != genders.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CDUCommunityMusicContext.Genders'  is null.");
            }
            var genders = await _context.Genders.FindAsync(id);
            if (genders != null)
            {
