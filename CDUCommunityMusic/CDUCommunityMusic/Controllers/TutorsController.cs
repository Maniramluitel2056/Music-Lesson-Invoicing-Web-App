...
namespace CDUCommunityMusic.Controllers
{
    public class TutorsController : Controller
    {
        ...
        public TutorsController(CDUCommunityMusicContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Tutors tutors)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Tutors tutors)
        {
            if (id != tutors.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CDUCommunityMusicContext.Tutors'  is null.");
            }
            var tutors = await _context.Tutors.FindAsync(id);
            if (tutors != null)
            {
